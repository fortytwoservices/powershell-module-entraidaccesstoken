...
### RELATED LINKS
## Add-EntraIDFederatedTokenFileAccessTokenProfile
...
```
Add-EntraIDFederatedTokenFileAccessTokenProfile [-Name <String>] [-Scope <String>] -TenantId <String>
 -File <String> -ClientId <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
