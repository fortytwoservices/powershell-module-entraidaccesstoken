...
```
ConvertFrom-Base64UrlEncodedString [-InputString] <String> [-ByteArray] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```
Get-AppendedSignature [-InputString] <String> [-Certificate] <X509Certificate2>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDAutomationAccountMSIAccessToken
...
#### default (Default)
```
Get-EntraIDAutomationAccountMSIAccessToken -AccessTokenProfile <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

#### resource
```
Get-EntraIDAutomationAccountMSIAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDAzureArcManagedMSIAccessToken
...
#### default (Default)
```
Get-EntraIDAzureArcManagedMSIAccessToken -AccessTokenProfile <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

#### resource
```
Get-EntraIDAzureArcManagedMSIAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDAzureDevOpsFederatedCredentialAccessToken
...
#### default (Default)
```
Get-EntraIDAzureDevOpsFederatedCredentialAccessToken -AccessTokenProfile <Object>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

#### resource
```
Get-EntraIDAzureDevOpsFederatedCredentialAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

#### scope
```
Get-EntraIDAzureDevOpsFederatedCredentialAccessToken -AccessTokenProfile <Object> [-Scope <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDAzurePowerShellSessionAccessToken
...
```
Get-EntraIDAzurePowerShellSessionAccessToken [-AccessTokenProfile] <Object>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDAzureVMMSIAccessToken
...
#### default (Default)
```
Get-EntraIDAzureVMMSIAccessToken -AccessTokenProfile <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

#### resource
```
Get-EntraIDAzureVMMSIAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDClientCertificateAccessToken
...
#### default (Default)
```
Get-EntraIDClientCertificateAccessToken -AccessTokenProfile <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

#### resource
```
Get-EntraIDClientCertificateAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

#### scope
```
Get-EntraIDClientCertificateAccessToken -AccessTokenProfile <Object> [-Scope <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDClientSecretAccessToken
...
#### default (Default)
```
Get-EntraIDClientSecretAccessToken -AccessTokenProfile <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

#### resource
```
Get-EntraIDClientSecretAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

#### scope
```
Get-EntraIDClientSecretAccessToken -AccessTokenProfile <Object> [-Scope <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDFederatedCredentialAccessToken
...
#### default (Default)
```
Get-EntraIDFederatedCredentialAccessToken -AccessTokenProfile <Object> -JWT <String> -ClientId <String>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
```
Get-EntraIDFederatedCredentialAccessToken -AccessTokenProfile <Object> -JWT <String> -ClientId <String>
 [-Resource <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDFunctionAppMSIAccessToken
...
#### default (Default)
```
Get-EntraIDFunctionAppMSIAccessToken -AccessTokenProfile <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

#### resource
```
Get-EntraIDFunctionAppMSIAccessToken -AccessTokenProfile <Object> [-Resource <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDGitHubFederatedCredentialAccessToken
...
```
Get-EntraIDGitHubFederatedCredentialAccessToken [-AccessTokenProfile] <Object>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### RELATED LINKS
## Get-EntraIDInteractiveUserAccessToken
...
```
Get-EntraIDInteractiveUserAccessToken [-AccessTokenProfile] <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```
Get-EntraIDROPCAccessToken [-AccessTokenProfile] <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```
Get-JWTHeader [-Certificate] <Object> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
```
Get-SignedJWT [-Payload] <Hashtable> [-Certificate] <Object> [[-DoNotAddJtiClaim] <Boolean>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
