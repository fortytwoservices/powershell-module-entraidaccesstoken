...
@{
    ...
    CmdletsToExport = @('Add-EntraIDAgentUserTokenProfile','Add-EntraIDAutomationAccountMSIAccessTokenProfile','Add-EntraIDAzureArcManagedMSITokenProfile','Add-EntraIDAzureDevOpsFederatedCredentialAccessTokenProfile','Add-EntraIDAzurePowerShellSessionTokenProfile','Add-EntraIDAzureVMMSIAccessTokenProfile','Add-EntraIDClientCertificateAccessTokenProfile','Add-EntraIDClientSecretAccessTokenProfile','Add-EntraIDExternalAccessTokenProfile','Add-EntraIDFederatedCredentialTokenProfile','Add-EntraIDFederatedTokenFileAccessTokenProfile','Add-EntraIDFunctionAppMSIAccessTokenProfile','Add-EntraIDGitHubFederatedCredentialAccessTokenProfile','Add-EntraIDInteractiveUserAccessTokenProfile','Add-EntraIDROPCAccessTokenProfile','Confirm-EntraIDAccessToken','ConvertFrom-EntraIDAccessToken','Get-EntraIDAccessToken','Get-EntraIDAccessTokenHasRoles','Get-EntraIDAccessTokenHasScopes','Get-EntraIDAccessTokenHeader','Get-EntraIDAccessTokenPayload','Get-EntraIDAccessTokenProfile','Get-EntraIDAccessTokenSecureString','Get-EntraIDAccessTokenType','Get-EntraIDAdminConsentUrl','Get-EntraIDAppPermission','New-DummyJWT','New-EntraIDAppPermission','Write-EntraIDAccessToken')
